...
- Define `channel_digest.subscription.set_requested.v1` and `channel_digest.run.requested.v1` command payloads with internal owner, Platform operation, stable idempotency, canonical public-channel locator or subscription reference, desired state/trigger, and exact UTC window semantics.
