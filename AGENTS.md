...
- ten contract crates — `crates/identifiers`, `crates/event-envelope`, `crates/error-contracts`, `crates/operation-contracts`, `crates/document-contracts`, `crates/social-contracts`, `crates/ai-archive-contracts`, `crates/backup-contracts`, `crates/notification-contracts`, `crates/blob-transfer-contracts`;
